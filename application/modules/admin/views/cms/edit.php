...
<div class="inner-right-panel">
    ...
    <!--Filter Section -->
    <?php echo form_open_multipart( base_url().'admin/cms/edit?data='.queryStringBuilder( "id=".$page_id ), array ('id' => 'cms_add_form') ); ?>
    <div class="form-item-wrap">
        <div class="form-item-title clearfix">
            <h3 class="title">Edit Content</h3>
            <div class="top-right-panel">
                <a href="http://localhost/shopoholic/admin/mysaveddeals/detail" class="deal-btn"><i class="fa fa-pencil" aria-hidden="true"></i></a>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-holder">
                            ...
                            <input type="text" class="form-control material-control" maxlength="150" name="title" placeholder="Enter the title" value="<?php
                             echo isset( $pages['name'] ) ? $pages['name'] : set_value( 'title' );
                            ?>">
