...
<div class="inner-right-panel">
    ...
    <!--Filter Section -->
    <?php echo form_open_multipart( base_url().'admin/version/edit?data='.queryStringBuilder( "id=".$version_id ), array ('id' => 'version_add_form') ); ?>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-xs-12">
                    <div class="form-group">
                        ...
                        <div class="input-holder">
                            <textarea class="custom-textarea" style="overflow:auto;resize:none" maxlength="100" name="desc" id="page_desc"><?php echo isset( $version['version_desc'] ) ? $version['version_desc']
                                    : set_value( 'desc' );
                            ?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="commn-select-wrap">
                            ...
                            <select class="selectpicker" name="platform">
                                ...
                                <option <?php
                                     if ( set_value( 'platform' ) == ANDROID || (isset( $version['platform'] ) && $version['platform'] == ANDROID) ) {
                                         echo "selected='selected'";
                                     }
                                    ?> value="<?php echo ANDROID; ?>">Android</option>
                                <option <?php
                             if ( set_value( 'platform' ) == IPHONE || (isset( $version['platform'] ) && $version['platform'] == IPHONE) ) {
                                 echo "selected='selected'";
                             }
                    ...
                    <div class="form-group">
                        ...
                        <div class="commn-select-wrap">
                            ...
                            <select class="selectpicker" name="update_type">
                                <option value="">Select</option>
                                <option <?php
 if ( set_value( 'update_type' ) == NORMAL || (isset( $version['update_type'] ) && $version['update_type'] == NORMAL) ) {
     echo "selected='selected'";
 }
?> value="<?php echo NORMAL; ?>">Normal</option>
                                <!-- <option <?php
                                    if ( set_value( 'update_type' ) == SKIPPABLE || (isset( $version['update_type'] ) && $version['update_type'] == SKIPPABLE) ) {
                                        echo "selected='selected'";
                                    }
?> value="<?php echo SKIPPABLE; ?>">Skippable</option>-->
                                <option <?php
                                    if ( set_value( 'update_type' ) == FORCEFULLY || (isset( $version['update_type'] ) && $version['update_type'] == FORCEFULLY) ) {
                                        echo "selected='selected'";
                                    }
                    ...
                    <div class="form-group">
                        ...
                        <div class="commn-select-wrap">
                            ...
                            <select class="selectpicker" name="current_version">
                                <option value="">Select</option>
                                <option <?php
 if ( set_value( 'current_version' ) == YES || (isset( $version['is_cur_version'] ) && $version['is_cur_version'] == YES) ) {
     echo "selected='selected'";
 }
?> value="<?php echo YES; ?>">Yes</option>
                                <option <?php
 if ( (set_value( 'current_version' ) == NO && set_value( 'current_version' ) != '') || (isset( $version['is_cur_version'] ) && $version['is_cur_version'] == NO) ) {
     echo "selected='selected'";
 }
