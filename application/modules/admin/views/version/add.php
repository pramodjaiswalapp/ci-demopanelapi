            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-xs-12">
                    <div class="form-group">
                        ...
                        <div class="input-holder">
                            <textarea  class="custom-textarea" maxlength="100" name="desc" style="overflow:auto;resize:none" id="page_desc"><?php echo set_value( 'desc' ); ?></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="commn-select-wrap">
                            ...
                            <select class="selectpicker" name="platform">
                                ...
                                <option <?php
                                 if ( set_value( 'platform' ) == ANDROID ) {
                                     echo "selected='selected'";
                                 }
                                ?> value="<?php echo ANDROID; ?>">Android</option>
                                <option <?php
                                if ( set_value( 'platform' ) == IPHONE ) {
                                    echo "selected='selected'";
                                }
                    ...
                    <div class="form-group">
                        ...
                        <div class="commn-select-wrap">
                            ...
                            <select class="selectpicker" name="update_type">
                                <option value="">Select</option>
                                <option <?php
                                 if ( set_value( 'update_type' ) == NORMAL ) {
                                     echo "selected='selected'";
                                 }
                                ?> value="<?php echo NORMAL; ?>">Normal</option>
                                <!--                                      <option <?php
                             if ( set_value( 'update_type' ) == SKIPPABLE ) {
                                 echo "selected='selected'";
                             }
                            ?> value="<?php echo SKIPPABLE; ?>">Skippable</option>-->
                                <option <?php
                             if ( set_value( 'update_type' ) == FORCEFULLY ) {
                                 echo "selected='selected'";
                             }
                    ...
                    <div class="form-group">
                        ...
                        <div class="commn-select-wrap">
                            ...
                            <select class="selectpicker" name="current_version">
                                <option value="">Select</option>
                                <option <?php
 if ( set_value( 'current_version' ) == YES ) {
     echo "selected='selected'";
 }
?> value="<?php echo YES; ?>">Yes</option>
                                <option <?php
 if ( set_value( 'current_version' ) == NO && set_value( 'current_version' ) != '' ) {
     echo "selected='selected'";
 }
