...
<div class="inner-right-panel">
                    ...
                    <select class="selectpicker filter country" name="country" data-live-search="true">
                        ...
                        if (!empty($countries)) {
                            foreach ($countries as $key => $val) {
                                ?>
                                <option <?php if (isset($country) && $country == $val['id']) {
    ...
    <label id="error">
        <?php
        $deleteArr = [];
        $deleteArr = $this->session->flashdata('deleteArr');
        if (isset($deleteArr) && !empty($deleteArr)) {
            ?>
                    ...
                    if (isset($userlist) && count($userlist)) {
                        ...
                        foreach ($userlist as $value) {
                            ...
                            <tr id ="remove_<?php echo $value['user_id']; ?>" >
                                <td><?php echo $i; ?></td>
                                <td><a href="<?php echo base_url() ?>admin/users/detail?id=<?php echo encryptDecrypt($value['user_id']); ?>"><?php echo ucfirst($value['first_name']) . ' ' . ucfirst($value['last_name']); ?></a></td>
...
<script src="<?php echo base_url() ?>public/js/datepicker.min.js">
                            < script >
